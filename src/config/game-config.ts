...
export const GameConfig = {
  ...
  beginner: {
    ...
    trainingLevels: [
      {
        id: 'win-hand',
        title: 'LESSON 1: WHAT\'S A WINNING HAND?',
        subtitle: 'Find the tile that makes a complete hand',
        description: 'To win at mahjong, you need 4 groups + 1 pair = 14 tiles.\n\nA "group" can be:\n• 3 same tiles (like 5-5-5)\n• 3 tiles in a row (like 1-2-3)\n\nA "pair" is 2 same tiles.\n\nYou have 13 tiles now. Pick the 14th tile that wins!',
        type: 'tenpai-win',
      },
      {
        id: 'waiting-tiles',
        title: 'LESSON 2: WHAT ARE YOU WAITING FOR?',
        subtitle: 'Find all tiles that would make you win',
        description: '"Tenpai" means you are 1 tile away from winning.\n\nYour hand might be waiting for MULTIPLE tiles.\n\nExample: if you have 2-3, you\'re waiting for 1 or 4.\n\nFind which tile(s) would complete your hand!',
        type: 'waiting-tiles',
      },
      {
        id: 'yaku-form',
        title: 'LESSON 3: YAKU = SCORING PATTERNS',
        subtitle: 'Find the tile that makes a special pattern',
        description: 'To win, you also need a "yaku" — a special pattern that scores points.\n\n"All Simples" (Tanyao) is the easiest yaku:\n• All tiles must be numbered 2-8\n• No 1s, no 9s, no special tiles\n\nFind the tile that makes this pattern!',
        type: 'yaku-form',
      },
      {
        id: 'discard-best',
        title: 'LESSON 4: WHAT TO THROW AWAY?',
        subtitle: 'Pick the tile you should discard',
        description: 'You have 14 tiles — throw 1 away to get closer to winning.\n\nGood strategy: keep tiles that can form many groups.\n\nThrow away tiles that are "lonely" — they don\'t match anything nearby.\n\nWhich tile is the most useless?',
        type: 'discard-best',
      },
      {
        id: 'safe-discard',
        title: 'LESSON 5: PLAYING SAFE',
        subtitle: 'Pick the safest tile to discard',
        description: 'Sometimes you can\'t win — then play safe!\n\nA "safe tile" won\'t let the opponent win.\n\nTiles that are hard to use are usually safe:\n• 1s and 9s (hard to make sequences)\n• Tiles that are already discarded\n\nWhich is the safest throw?',
        type: 'safe-discard',
      },
    ],
    tutorialSteps: [
