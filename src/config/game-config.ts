    ...
    trainingLevels: [
      {
        ...
        subtitle: '',
        description: 'Pick the tile that completes a winning hand (4 groups + 1 pair = 14 tiles).',
        type: 'tenpai-win',
      },
      {
        id: 'waiting-tiles',
        ...
        subtitle: '',
        description: 'Find all tiles that would make you win.',
        type: 'waiting-tiles',
      },
      {
        id: 'yaku-form',
        ...
        subtitle: '',
        description: 'Find the tile that forms a scoring pattern (like Tanyao: only tiles 2-8).',
        type: 'yaku-form',
      },
      {
        id: 'discard-best',
        ...
        subtitle: '',
        description: 'Throw away the least useful tile to get closer to winning.',
        type: 'discard-best',
      },
      {
        id: 'safe-discard',
