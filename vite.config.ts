  ...
  build: {
    rollupOptions: {
      input: {
        ...
        mahjongTileMeanings: resolve(__dirname, 'mahjong-tile-meanings.html'),
        riichiMahjongRules: resolve(__dirname, 'riichi-mahjong-rules.html'),
        mahjongScoringGuide: resolve(__dirname, 'mahjong-scoring-guide.html'),
